...
switch (_filter) do
{
	...
	{
		[
			["H_Bandanna_camo","Camo Bandana",120],
			["H_Bandanna_surfer","Surfer Bandnna",130],
			["H_Bandanna_gry","Gris Bandana",150],
			["H_Bandanna_cbr",nil,165],
			["H_Bandanna_surfer",nil,135],
			["H_Bandanna_khk","Khaki Bandana",145],
			["H_Bandanna_sgg","Sage Bandana",160],
			["H_StrawHat","Straw Fedora",225],
			["H_BandMask_blk","Chapeau & Bandana",300],
