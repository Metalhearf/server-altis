...
__CONST__(life_revive_fee,400); //Fee for players to pay when revived.
...
__CONST__(life_enableFatigue,false); //Enable (true) / Disable (false) the ARMA 3 Fatigue System
